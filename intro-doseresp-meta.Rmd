...
What does the Q statistic test in this model?  It tests whether there is heterogeneity in the trends estimated for the 6 studies. To show this, I'm going to estimate the trend for each study, and perform a random effects meta-analysis of the 6 estimated trend coefficients.
```{r meta-eachstudy}
